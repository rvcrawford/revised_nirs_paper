...
Trials in Geneva and Ithaca were generally planted and harvested near the same date, and samples were analyzed within the same few weeks between field seasons. The likeliest explanation is variation in sample-handling, particularly harvesting and grain-cleaning. However, the exact reason for these differences is unknowable.

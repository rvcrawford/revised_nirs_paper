...
eval_criteria <- data.frame(
  ...
  RPIQ = c("> 4.1", "2.3 - 4.1", "1.5 - 2.3", "< 1.5"),
  R_squared = c("> 0.9", "0.8 - 0.9", "0.5 - 0.8", "< 0.5"),
  Interpretation = c(
...
kable(eval_criteria, 
      col.names = c("Category", "RPD", "RPIQ", "R²", "Interpretation"),
      caption = "Unified Model Evaluation Criteria for NIRS Prediction Models")
```
